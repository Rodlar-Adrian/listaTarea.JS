...
(function(){
    ...
    botonBuscar = document.getElementById('boton1');
    contenedorPokemon = document.getElementById('contenedor');
    inputBusqueda1 = document.getElementById('input3');
...
botonBuscar.addEventListener('click', (e) =>{
    encontrarPokemon(inputBusqueda1.value);
});
